...
// Based on a G1's "TestMarkStackOverflow.java" test.

/* @test TestMarkStackOverflow.java
 * @run main/othervm -XX:-UseCompressedOops -XX:+UseG1GC -XX:+SanitizeGC -XX:G1HeapRegionSize=16m -XX:ActiveProcessorCount=2 -XX:MarkStackSize=1 -Xmx256m gc.SanitizeGC.TestMarkStackOverflow
 */
